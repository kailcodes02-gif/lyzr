      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="bg-white border border-zinc-200 rounded-2xl p-8 shadow-xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border border-zinc-300 text-zinc-900 font-medium rounded-xl hover:bg-zinc-50 transition-all duration-200 cursor-pointer"
          >
