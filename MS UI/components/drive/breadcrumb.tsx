          ...
          <span key={c.id} className="flex min-w-0 items-center">
            ...
            <button
              ...
              className={cn(
                ...
                last ? "cursor-default text-foreground" : "text-muted-foreground hover:bg-muted hover:text-foreground",
